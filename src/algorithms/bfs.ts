...
// Check whether a node satisfies a non-extreme BFS goal.
...
// Build outgoing adjacency lists based on edge direction.
...
// Execute BFS traversal from the given start label and return visit steps + goal result.
export const runBfs = (input: BfsInput): BfsResult => {
